...
namespace WellDone.ViewModels
{
    public sealed partial class MainPageViewModel : ViewModel, IMainPageViewModel
    {
        ...
        public MainPageViewModel(IDialogService dialogService, IMobileServiceClient mobileServiceClient, INavigationService navigationService, IResourceLoader resourceLoader)
        {
        ...
        public async override void OnNavigatedTo(object navigationParameter, Windows.UI.Xaml.Navigation.NavigationMode navigationMode, Dictionary<string, object> viewModelState)
        {
            ...
            _mobileServiceClient.CurrentUser = LoggedUser;               
        ...
        private void MobileServiceExceptionNotification()
        {
                    ...
                    switch (parameter)
                    {
                        ...
                        default:
                            ...
                            if (projectName.Any())
                            {
                                ...
                                Tasks = await wellDoneTable.Where(list => list.ProjectId == projectName.FirstOrDefault().Id && list.IsComplete == false).OrderByDescending(t => t.CreatedAt).ToCollectionAsync();
                            }
                            IsTaskControlVisibile = false;
                            }
                            break;
